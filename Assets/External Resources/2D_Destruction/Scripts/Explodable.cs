...
public class Explodable : MonoBehaviour
{
    ...
    public void explode()
    {
        ...
        GameObject fragParent;
        fragParent = new GameObject("fragParent");
        //Add Components
        fragParent.AddComponent<SelfDestruct>();
        fragParent.GetComponent<SelfDestruct>().ToDestruct(5);
        foreach (GameObject frag in fragments)
        {
            frag.transform.parent = fragParent.transform;
            frag.SetActive(true);
        }
